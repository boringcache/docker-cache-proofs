...
|---:|---|---|---|---|---|---|
| 1 | `aranya-rust` | Rust/sccache | `aranya-project/aranya` maintainers | [`aranya#135`](https://github.com/aranya-project/aranya/issues/135), [recent unit-test run](https://github.com/aranya-project/aranya/actions/runs/26174641840), [fresh proof](https://github.com/boringcache/docker-cache-proofs/actions/runs/26958655351), [rolling2 proof](https://github.com/boringcache/docker-cache-proofs/actions/runs/26961876589) | Open issue; maintainers say GHA sccache is not ideal and discuss S3-backed sccache. Recent unit-test runs are still about 14-22m. BoringCache reaches 100% native-tool hit rate by rolling2 with 0 cache errors/timeouts, but the command still takes about 12m because non-cacheable/test work remains. | Pitch-ready with caveat: lead with compiler-cache misses going to zero, then ask whether the remaining tail is tests/runtime or another cacheable layer. |
